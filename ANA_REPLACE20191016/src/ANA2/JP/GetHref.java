...
public class GetHref extends DefaultJavaTestScript  {
        ...
        try {
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                ...
                if (file.isFile() && file.getName().endsWith(".html")) {
                    ...
                    getContext().setVariable("check_detail", "topRequestException: " + path_file_html);
                }
            }
    ...
    public void writeListHrefToFile(ArrayList<String> arr_hrefs, ArrayList<String> arr_titles, String name_file){
        try{
            ...
            if(fullPath.indexOf("ANA1") >= 0){
                fullPath = fullPath.replace("ANA1/",  "");
            }else if(fullPath.indexOf("ANA2") >= 0){
                fullPath = fullPath.replace("ANA2/",  "");
            }
